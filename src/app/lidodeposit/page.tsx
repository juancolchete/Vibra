...
import styles from "./lidodeposit.module.css";
          ...
          <div className="col-md-6 col-lg-6 offset-md-3   ">
            <div className={styles.content}>
              ...
              <div className={styles.cards}>
                <img src={ok} alt="" />
                <Title size="1.125rem">Deposit Confirmed</Title>
                <Text size="0.875rem" color="##fcfcfc66" center>
                  All right with your deposit, you have received{" "}
                  <span style={{ color: "#fff" }}>R$ 3,00</span> in DREX.
                </Text>
